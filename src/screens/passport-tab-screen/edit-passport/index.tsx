              ...
              <VStack style={styles.editSummary}>
                <VStack justify="center" align="center">
                  <Pressable
                    ...
                    <Text
                      style={[styles.editPhotoText, { textTransform: 'none' }]}>
                ...
                <VStack align="flex-start" style={styles.editModalRow}>
                  ...
                  <Input
                    ...
                    style={{ color: Colors.DARK_PURPLE }}
                    onChangeText={text =>
                      updateUserDataLocal('pronounce', text)
                    }
                  ...
                  <TouchableOpacity
                    ...
                    <ArrowDown
                      size={'small'}
                      color={Colors.DARK_PURPLE}></ArrowDown>
                  </TouchableOpacity>
                </VStack>
                ...
                <HStack
                  style={[styles.editModalRow, styles.editButtonContainer]}>
                  <Button
                    isLoading={false}
