...
const Tile = function Tile(centerPoint, hexSize) {
...
Tile.prototype.getLatLon = function getLatLon(radius, boundaryNum) {
...
Tile.prototype.scaledBoundary = function scaledBoundary(scale) {
