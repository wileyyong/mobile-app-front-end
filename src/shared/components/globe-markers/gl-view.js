 ...
 * necessary component but only supports for React Web Version
 */
...
const Html = /*#__PURE__*/React.forwardRef(({
  ...
  const [el] = React.useState(() => React.createElement(as)); // @ts-expect-error React 18 types aren't available yet
